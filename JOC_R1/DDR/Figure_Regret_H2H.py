...
class Regret_H2H:
    ...
    def Upper_Right(self,all_x, all_y, figure_name, size = (5, 5), move = [-0.12, 0.04, 0.35, 0.55], ysame = 0, yrange = [6,6], sublabel = '', ypio = 0):
    ...
    def Upper_Left(self,all_x, all_y, figure_name, size = (5, 5), move = [-0.12, 0.04, 0.35, 0.55], ysame = 0, yrange = [6,6], sublabel = '', ypio = 0):
        data = np.asarray([all_x,all_y])
    ...
    def Lower_Right(self,all_x, all_y, figure_name, size = (5, 5), move = [-0.12, 0.04, 0.35, 0.55], ysame = 0, yrange = [6,6], sublabel = '', ypio = 0):
        data = np.asarray([all_x,all_y])
    ...
    def Lower_Left(self,all_x, all_y, figure_name, size = (5, 5), move = [-0.12, 0.04, 0.35, 0.55], ysame = 0, yrange = [6,6], sublabel = '', ypio = 0):
        data = np.asarray([all_x,all_y])
